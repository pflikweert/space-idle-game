...
5. For VOID DRIFTER, verify the Godot route and Codex route when relevant:
   - `http://localhost:8081/void-drifter`
   - `http://localhost:8081/void-drifter/enemies`
   Also check wide desktop, mobile-sized, and short-height viewports for sprite cropping, Codex previews, and bottom HUD overlap when gameplay UI or assets changed.
